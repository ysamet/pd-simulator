...
- **Design 12** — `site_capacity` pinned at 1 and deferred to M19.
- The **Parameters** table.
- The **Phase plan** with reset markers and its risk reading.
- The **§12 checklist** as an enumerated audit list.
- The **Validation** section (V1–V8), written at spec time.
- The four registered **scenarios**.
- The **bench** structure column and its two falsifiable hypotheses.
- The **out-of-scope** section.
- The **docs obligations** (DECISIONS entries and ROADMAP amendments).
